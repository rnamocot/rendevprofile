        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-24 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border border-gray-200 bg-white/50 backdrop-blur-sm text-xs sm:text-sm text-gray-700">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
                <span className="text-gray-900 block">Building</span>
                <span className="text-gray-600 block">Impactful Digital</span>
                <span className="text-gray-600 block">Experiences</span>
              </h1>
              
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-none lg:max-w-lg leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a
                href="#contact"
                className="group inline-flex items-center justify-center gap-2 bg-gray-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-medium hover:bg-gray-800 transition-all duration-200 hover:scale-105"
              >
                Start Project
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 border border-gray-300 text-gray-700 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-medium hover:border-gray-900 hover:text-gray-900 transition-all duration-200 cursor-pointer"
              >
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-8 pt-6 sm:pt-8 border-t border-gray-100">
              <div className="text-center sm:text-left">
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-0.5 sm:mb-1">500+</div>
                <div className="text-xs sm:text-sm text-gray-600 uppercase tracking-wider">Projects</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-0.5 sm:mb-1">8+</div>
                <div className="text-xs sm:text-sm text-gray-600 uppercase tracking-wider">Years Exp</div>
              </div>
              <div className="text-center sm:text-left">
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-0.5 sm:mb-1">100%</div>
          ...
          <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
            <div className="relative z-10 aspect-square max-w-xs sm:max-w-sm md:max-w-md mx-auto">
